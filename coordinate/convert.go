...
func IsInChina(coord geography.Point) bool {
...
func transform(x, y float64, factors []float64) geography.Point {
	...
	return geography.Point{xt, yt}
}

// GCJ02ToWGS84 ...
func GCJ02ToWGS84(coord geography.Point) geography.Point {
	...
	for ok := true; ok == true; ok = math.Abs(dx) > 1e-6 || math.Abs(dy) > 1e-6 {
		...
		tempPoint = WGS84ToGCJ02(geography.Point{wgsLon, wgsLat})
		dx = tempPoint.Lon() - lon
		dy = tempPoint.Lat() - lat
	}

	return geography.Point{wgsLon, wgsLat}

}

// WGS84ToGCJ02 ...
func WGS84ToGCJ02(coord geography.Point) geography.Point {
	...
	return geography.Point{lon + d[0], lat + d[1]}
}

// BD09ToGCJ02 ...
func BD09ToGCJ02(coord geography.Point) geography.Point {
	...
	return geography.Point{newLon, newLat}
}

// GCJ02ToBD09 ...
func GCJ02ToBD09(coord geography.Point) geography.Point {
...
// BD09toBD09MC ...
func BD09toBD09MC(coord geography.Point) geography.Point {
...
// BD09MCtoBD09 ...
func BD09MCtoBD09(coord geography.Point) geography.Point {
...
// WGS84ToBD09 ...
func WGS84ToBD09(coord geography.Point) geography.Point {
	return GCJ02ToBD09(WGS84ToGCJ02(coord))

}

// BD09ToWGS84 ...
func BD09ToWGS84(coord geography.Point) geography.Point {
