...
func TestImageAddress(t *testing.T) {
	t.Run("String", func(t *testing.T) {
		...
		t.Run("url", func(t *testing.T) {
			var img = Address{
				URL: "http://img.rockontrol.com/avatar/abc.png",
			}
			NewWithT(t).Expect(img.String()).To(Equal("http://img.rockontrol.com/avatar/abc.png"))
		})
		t.Run("asset", func(t *testing.T) {
			var address = Address{
				Group: "avatar",
	...
	t.Run("ParseAddress", func(t *testing.T) {
		t.Run("url", func(t *testing.T) {
			a := "http://img.rockontrol.com/avatar/abc.png"
